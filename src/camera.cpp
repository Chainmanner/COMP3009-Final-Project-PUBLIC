...
// Include this file in EVERY .cpp FILE and BEFORE ANYTHING ELSE!
#include <constants.h>

#include <camera.h>

//position(1.0,1.0,1.0)
Camera::Camera(void) : position(1.0, 1.0, 1.0), forwardVector(0.0, 0.0, 100.0), upVector(0.0, 1.0, 0.0)
...
glm::mat4 Camera::GetViewMatrix() { //glm::mat4 *viewMatrix
	...
	/*if (position != NULL)
		if (GetLookAtPoint() != NULL)
			if (GetUp() != NULL) //* viewMatrix = m;*/
	m = glm::lookAt(position, GetLookAtPoint(), GetUp());
